...
<main class="page grid grid-cols-3 items-center h-full min-h-[640px] overflow-hidden">
    ...
    <!-- Media -->
    <section class="col-span-2 h-full py-4 px-20 bg-black/20 border-l border-white/10 backdrop-blur-sm flex flex-col items-center space-y-10 overflow-y-auto">
