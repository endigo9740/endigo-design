...
screenshots:
  [
    ...
    },
    {
      ...
      caption: Vehicle selection and customization,
    },
    {
      src: /screenshots/jackpot-rising/speedleague/005.png,
      caption: An intro cinematic for the Tucson map,
    },
    {
...
Speedleague is an international motorsports league created by Red Bull’s Global Rallycross Championship creator Brian Gale. Building on the League's role as a sports organizer for X-Games motorsports and its partnership with ESPN, Jackpot Rising took on the challenge of developing a mobile racing video game to help promote and run tournaments alongside each real-world race, which would be held at locations such as The Bahamas, St. Petersburg, Dubai, and more. I designed the UX, implemented the game interface, and provided minor contributions to the game development. The game was originally developed in Unity, but later ported to the Unreal Engine.
